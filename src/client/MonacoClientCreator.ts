...
export class MonacoClientCreator {
   ...
   */
  public static async createOvlEditor(): Promise<
    monaco.editor.IStandaloneCodeEditor
  > {
    return monaco.editor.create(document.getElementById("monaco-editor")!, {
      model: monaco.editor.createModel(
        ContentManager.getValue(ContentEnum.Code),
        "ov",
        monaco.Uri.parse("inmemory://model.ov")
      ),
      theme: "vs-dark",
   ...
   * @memberof MonacoClient
   */
  public static async createOutputEditor(): Promise<
    monaco.editor.IStandaloneCodeEditor
  > {
    return monaco.editor.create(document.getElementById("generated-code")!, {
      model: monaco.editor.createModel(
        "",
        "java",
        monaco.Uri.parse("inmemory://model.java")
      ),
      theme: "vs",
      readOnly: true,
      automaticLayout: true,
   ...
   * @memberof MonacoClient
   */
  public static async createSchemaEditor(): Promise<
    monaco.editor.IStandaloneCodeEditor
  > {
    return monaco.editor.create(document.getElementById("schema-definition")!, {
      model: monaco.editor.createModel(
        ContentManager.getValue(ContentEnum.Schema),
        "yaml",
        monaco.Uri.parse("inmemory://schemaDefinition.yaml")
      ),
      theme: "vs-dark",
      automaticLayout: true,
      glyphMargin: true,
