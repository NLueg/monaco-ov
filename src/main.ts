import { LspClientCreator } from "./client/LspClientCreator";
import { MonacoClientCreator } from "./client/MonacoClientCreator";
...
async function createEditors() {
  MonacoClientCreator.setOvLanguageSupport();
  ...
  LspClientCreator.createLspClient(ovlEditor, schemaEditor, outputEditor);
}
