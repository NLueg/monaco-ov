...
import { Workspace, WorkspaceEdit, TextDocumentDidChangeEvent, TextDocument, Event, Emitter, Configurations } from './services';
import IModel = monaco.editor.IModel;
import IIdentifiedSingleEditOperation = monaco.editor.IIdentifiedSingleEditOperation;
import { MonacoConfigurations } from './monaco-configuration';
...
export class MonacoWorkspace implements Workspace {
    ...
    constructor(
        ...
        this.configurations = new MonacoConfigurations();
    }
